...
export const CategoryHeader = memo(({ categorySlug, searchQuery, setSearchQuery, handleSearch, showFilters, setShowFilters, sortBy, setSortBy, viewMode, setViewMode }: {
    categorySlug?: string;
    searchQuery: string;
