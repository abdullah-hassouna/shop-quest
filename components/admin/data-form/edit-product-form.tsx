...
import { editProductAction } from "@/actions/admin/products/edit-product";
...
export function EditProductForm({
  ...
  >([{ id: "t-1", price: product.price, label: "Type 1" }]);
  ...
  return (
    <Formik
      initialValues={{
        ...
        price: product.price || "",
        stock: "0",
        category: product.category?.id || "no-cate",
      ...
      onSubmit={async (values, { setSubmitting }) => {
        ...
        try {
          ...
          const { data, error, success } = await editProductAction({
            id: product.id,
            ...values,
