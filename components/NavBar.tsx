...
// import useUserDataStore, { UserData } from '@/store/user-store';
...
//     const cartItems = useCartStore((state: { cart: CartItem }) => state.cart);
//     const userData = useUserDataStore((state: { user: UserData }) => state.user);
