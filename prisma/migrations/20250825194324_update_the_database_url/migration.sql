-- CreateEnum
CREATE TYPE "public"."Role" AS ENUM ('BUYER', 'ADMIN');

-- CreateEnum
CREATE TYPE "public"."OrderStatus" AS ENUM ('PENDING', 'SHIPPED', 'DELIVERED', 'CANCELLED');

-- CreateEnum
CREATE TYPE "public"."AnoouncementType" AS ENUM ('INFO', 'WARNING', 'SUCCESS', 'ERROR');
...
-- CreateTable
CREATE TABLE "public"."Anoouncement" (
    "id" TEXT NOT NULL,
    "message" TEXT NOT NULL,
    "type" "public"."AnoouncementType" NOT NULL,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "Anoouncement_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "_RoomUsers_B_index" ON "public"."_RoomUsers"("B");
...
-- AddForeignKey
ALTER TABLE "public"."_RoomUsers" ADD CONSTRAINT "_RoomUsers_A_fkey" FOREIGN KEY ("A") REFERENCES "public"."Room"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "public"."_RoomUsers" ADD CONSTRAINT "_RoomUsers_B_fkey" FOREIGN KEY ("B") REFERENCES "public"."User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
