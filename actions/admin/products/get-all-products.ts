...
export const getAllProducts = cache(
  async (
    ...
    take: number = 2,
    search: string = "",
    orderBy?: { order: string; sort: "asc" | "desc" } | null
  ): Promise<ActionReturnType<GetProductDataResponse[]>> => {
...
export const getAllProductsPages = cache(
  async (
    take: number = 2,
    search: string = ""
  ): Promise<ActionReturnType<number>> => {
    try {
